...
import adminAgentRunRoutes from './routes/adminAgentRunRoutes.js';
import vendorAgentRunRoutes from './routes/vendorAgentRunRoutes.js';
import vendorApprovalRoutes from './routes/vendorApprovalRoutes.js';
import weeklyReportRoutes from './routes/weeklyReportRoutes.js';
import firmFactsRoutes from './routes/firmFactsRoutes.js';
...
app.use('/api/admin/agent-runs', adminAgentRunRoutes);
...
app.use('/api/admin/vendors/:vendorId/reports', adminReportRoutes);
...
app.use('/api/aeo-audit', aeoAuditRoutes);
// Backward compat redirect from old /api/geo-audit paths
