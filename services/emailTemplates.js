...
export const vendorWelcomeTemplate = ({ vendorName, loginUrl, dashboardUrl }) => wrapTemplate(`
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Need help getting started? Check out our <a href="https://tendorai.com/for-vendors" style="color: #7c3aed;">Vendor Guide</a> or reply to this email.</p>
    </div>
    <div class="footer">
...
export const reviewNotificationTemplate = ({ vendorName, reviewerName, rating, title, content, dashboardUrl }) => {
  ...
  <div class="container">
    ...
    <div class="footer">
      <p><a href="https://tendorai.com">TendorAI</a> - Building trust through transparency</p>
    </div>
  </div>
`);
};
...
export const aeoReportTemplate = ({ companyName, category, city, score, aiMentioned, reportUrl }) => {
  ...
  <div class="container">
    ...
    <div class="footer">
      <p>This report was generated by <a href="https://tendorai.com">TendorAI</a></p>
