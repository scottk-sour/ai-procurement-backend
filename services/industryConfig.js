 ...
 *
 * NOTE: The 'benchmark' strings are editorial estimates for email copy only.
 * For real computed averages, use utils/computeIndustryAverage.js which
 * queries actual report data from the database.
 */
...
const DEFAULT_CONFIG = {
  ...
  benchmark: 'The average score in your sector is estimated at around 35/100 — most businesses haven\'t optimised for AI yet.',
  regulatorNote: null,
};
...
const INDUSTRY_CONFIG = {
  ...
  conveyancing: {
    ...
    benchmark: 'The average conveyancing firm scores an estimated 28/100. Most haven\'t claimed any AI presence at all.',
  ...
  'family-law': {
    ...
    benchmark: 'The average family law firm scores an estimated 25/100. Most have no AI-readable practice data.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  'criminal-law': {
    ...
    benchmark: 'The average criminal law firm scores an estimated 22/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  'commercial-law': {
    ...
    benchmark: 'The average commercial law firm scores an estimated 30/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  'employment-law': {
    ...
    benchmark: 'The average employment law firm scores an estimated 26/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  'wills-and-probate': {
    ...
    benchmark: 'The average wills and probate firm scores an estimated 24/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  immigration: {
    ...
    benchmark: 'The average immigration firm scores an estimated 27/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  'personal-injury': {
    ...
    benchmark: 'The average personal injury firm scores an estimated 29/100.',
    regulatorNote: 'This report uses verified data from the SRA Solicitors Register.',
  },
  ...
  'tax-advisory': {
    ...
    benchmark: 'The average tax advisory firm scores an estimated 31/100.',
  ...
  'audit-assurance': {
    ...
    benchmark: 'The average audit firm scores an estimated 33/100.',
    regulatorNote: 'This report uses data from the ICAEW directory.',
  },
  bookkeeping: {
    ...
    benchmark: 'The average bookkeeping practice scores an estimated 23/100.',
    regulatorNote: null,
  },
  payroll: {
    ...
    benchmark: 'The average payroll provider scores an estimated 25/100.',
    regulatorNote: null,
  },
  'corporate-finance': {
    ...
    benchmark: 'The average corporate finance firm scores an estimated 34/100.',
    regulatorNote: 'This report uses data from the ICAEW directory.',
  },
  'business-advisory': {
    ...
    benchmark: 'The average business advisory firm scores an estimated 30/100.',
    regulatorNote: 'This report uses data from the ICAEW directory.',
  },
  'vat-services': {
    ...
    benchmark: 'The average VAT services provider scores an estimated 26/100.',
    regulatorNote: null,
  },
  'financial-planning': {
    ...
    benchmark: 'The average financial planner scores an estimated 28/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },

  // --- Mortgage advisors ---
  'residential-mortgages': {
    industryLabel: 'residential mortgage adviser',
    ...
    benchmark: 'The average mortgage advisor scores an estimated 27/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  'buy-to-let': {
    industryLabel: 'buy-to-let mortgage adviser',
    ...
    benchmark: 'The average BTL mortgage advisor scores an estimated 25/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  remortgage: {
    industryLabel: 'remortgage adviser',
    ...
    benchmark: 'The average remortgage advisor scores an estimated 26/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  'first-time-buyer': {
    industryLabel: 'first-time buyer mortgage adviser',
    ...
    benchmark: 'The average first-time buyer advisor scores an estimated 24/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  'equity-release': {
    industryLabel: 'equity release adviser',
    ...
    benchmark: 'The average equity release advisor scores an estimated 23/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  'commercial-mortgages': {
    industryLabel: 'commercial mortgage adviser',
    ...
    benchmark: 'The average commercial mortgage broker scores an estimated 29/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },
  'protection-insurance': {
    industryLabel: 'protection insurance adviser',
    ...
    benchmark: 'The average protection advisor scores an estimated 22/100.',
    regulatorNote: 'This report uses data from the FCA Financial Services Register.',
  },

  // --- Estate agents ---
  sales: {
    industryLabel: 'estate agent',
    ...
    benchmark: 'The average estate agent scores an estimated 32/100.',
    regulatorNote: null,
  },
  lettings: {
    industryLabel: 'letting agent',
    ...
    benchmark: 'The average letting agent scores an estimated 29/100.',
    regulatorNote: null,
  },
  'property-management': {
    industryLabel: 'property management agent',
    ...
    benchmark: 'The average property management agent scores an estimated 27/100.',
    regulatorNote: null,
  },
  'block-management': {
    industryLabel: 'block management agent',
    ...
    benchmark: 'The average block management agent scores an estimated 26/100.',
    regulatorNote: null,
  },
  auctions: {
    industryLabel: 'property auction specialist',
    ...
    benchmark: 'The average auction house scores an estimated 30/100.',
    regulatorNote: null,
  },
  'commercial-property': {
    industryLabel: 'commercial property agent',
    ...
    benchmark: 'The average commercial property agent scores an estimated 31/100.',
    regulatorNote: null,
  },
  inventory: {
    industryLabel: 'inventory services provider',
    ...
    benchmark: 'The average inventory provider scores an estimated 21/100.',
    regulatorNote: null,
  },
  ...
  copiers: {
    ...
    benchmark: 'The average managed print supplier scores an estimated 35/100.',
    regulatorNote: null,
  },
  telecoms: {
    ...
    benchmark: 'The average telecoms provider scores an estimated 33/100.',
    regulatorNote: null,
  },
  cctv: {
    ...
    benchmark: 'The average security installer scores an estimated 28/100.',
    regulatorNote: null,
  },
  it: {
    ...
    benchmark: 'The average IT support provider scores an estimated 30/100.',
    regulatorNote: null,
  },
