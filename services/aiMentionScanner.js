...
const VENDOR_TYPE_CONFIG = {
  ...
  'mortgage-advisor': {
    ...
    templates: (area, city) => [
      `Best mortgage advisers in ${city} for ${area}`,
      `Who should I use for a ${area} mortgage in ${city}?`,
      `Can you recommend a mortgage broker in ${city} specialising in ${area}?`,
      `I need a ${area} mortgage adviser in ${city} — who do you recommend?`,
      `Which mortgage advisers in ${city} are best for ${area}?`,
    ],
    fallbackArea: 'residential mortgages',
  },
  'estate-agent': {
    label: 'estate agent',
    templates: (area, city) => [
      `Best estate agents in ${city} for ${area}`,
      `Who are the top estate agents in ${city} specialising in ${area}?`,
      `Which estate agent should I use in ${city} for ${area}?`,
      `Can you recommend a good estate agent in ${city} for ${area}?`,
      `I need an estate agent in ${city} for ${area} — who do you recommend?`,
    ],
    fallbackArea: 'residential sales',
  },
  'financial-advisor': {
    label: 'financial adviser',
    templates: (area, city) => [
      `Best financial advisers in ${city} for ${area}`,
      `Can you recommend a financial adviser in ${city} specialising in ${area}?`,
      `Who are the top financial advisers in ${city} for ${area}?`,
      `I need a financial adviser in ${city} for ${area} — who do you recommend?`,
      `Which financial advisers in ${city} are best for ${area}?`,
    ],
    fallbackArea: 'financial planning',
  },
  'insurance-broker': {
    label: 'insurance broker',
    templates: (area, city) => [
      `Best insurance brokers in ${city} for ${area}`,
      `Can you recommend an insurance broker in ${city} specialising in ${area}?`,
      `Who are the top insurance brokers in ${city} for ${area}?`,
      `I need an insurance broker in ${city} for ${area} — who do you recommend?`,
      `Which insurance brokers in ${city} are best for ${area}?`,
    ],
    fallbackArea: 'business insurance',
  },
  'office-equipment': {
    label: 'office equipment supplier',
    templates: (area, city) => [
      `Best office equipment suppliers in ${city} for ${area}`,
      `I need a ${area} supplier in ${city} — who should I use?`,
      `Can you recommend a good office equipment company in ${city} for ${area}?`,
      `Which office equipment suppliers in ${city} are best for ${area}?`,
      `Who are the top ${area} suppliers near ${city}?`,
    ],
    fallbackArea: 'photocopiers and managed print',
  },
};
