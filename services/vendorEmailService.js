        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    ...
                    <p style="margin:12px 0 0;">
                      <a href="${upgradeUrl}" style="display:inline-block;background:#7c3aed;color:#ffffff;padding:10px 20px;text-decoration:none;border-radius:6px;font-size:13px;font-weight:600;">Upgrade to Pro</a>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:20px 40px;text-align:center;">
              ...
              ${!isPaid ? `
              <p style="margin:12px 0 0;">
                <a href="${upgradeUrl}" style="font-size:13px;color:#7c3aed;text-decoration:underline;">Upgrade to Pro</a>
              </p>
              ` : ''}
            </td>
          </tr>
